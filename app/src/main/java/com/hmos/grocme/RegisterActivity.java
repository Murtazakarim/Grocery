...
public class RegisterActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        et_password.setText(phone.substring(3,9));
        et_email.setText(phone+"@phone.com");
     ...
     */
    private void makeRegisterRequest(String name, final String mobile,
        ...
        String reg = BaseURL.REGISTER_URL;

        CustomVolleyJsonRequest jsonObjReq = new CustomVolleyJsonRequest(Request.Method.POST, reg, params, new Response.Listener<JSONObject>() {
...
//                        Toast.makeText(RegisterActivity.this, "" + error, Toast.LENGTH_SHORT).show();
                    ...
                    startActivity(new Intent(RegisterActivity.this, LoginActivity.class).putExtra("email", email).putExtra("password", password));
                    finish();
